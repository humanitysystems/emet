...
- Current task: v1.5.0 — Emet landing page shipped at https://humanitysystems.github.io/emet (emet#2 closed). Hosting decision: project pages on this repo (`docs/` + `.github/workflows/pages.yml`), not an org-site subpath — the org Pages repo doesn't exist and creating it is a hard boundary (workspace#2 parked on it). Source in `docs/` is portable to a subpath if the org site is later created. Field note: `notes/2026-09-21-landing-page.md`.
