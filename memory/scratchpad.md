...
- Current task: v1.5.5 — landing page hero headline is now just the word: אמת (tagline "— I stand behind the record." dropped, dead `.gradient` CSS removed). Prior state: v1.5.4 — Emet landing page restyled to the Cosmic Kabbalah design system. New `docs/design.md` (YAML tokens + guide: void `#0B0E17`, gold `#E0C068`, cyan `#5EEAD4`, magenta `#F43F5E`, glass panels, Cinzel/Plus Jakarta Sans/Space Grotesk); `style.css` rewritten (nebula + starfield bg, glass cards, avatar as Sefirot sphere, celestial gold CTAs, cosmic band for the soul section); fonts swapped in `index.html`. Field note: `notes/2026-09-21-cosmic-kabbalah.md`; stale Neuron/Parchment claim corrected in `notes/2026-09-21-landing-page.md`. Prior state: v1.5.3 — landing page live at https://humanitysystems.github.io/emet (emet#2 closed), project pages on this repo (`docs/` + `.github/workflows/pages.yml`), source portable to an org-site subpath if workspace#2's org repo is later created.
